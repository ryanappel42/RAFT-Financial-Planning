      ...
      <div className="about-page">
        <div className="about-content">
          <section className="about-section">
            ...
            <h2>What is RAFT: Financial Planning?</h2>
            <p>
              RAFT: Financial Planning is a full financial planning platform built as a portfolio project.
          ...
          <section className="about-section">
            ...
            <p>
              ...
              Financial Planning & Wealth Management and FinTech & Big Data Analytics with
              a minor in Artificial Intelligence. He's currently a Financial AI and
              Innovation Intern at OLIO Financial Planning, holds VP roles in Delta Sigma
              Pi (Professional Activities) and Phi Delta Theta, and sits on the Pamplin
              Dean's Advisory Board of Students.
            </p>
            <p>
              He built RAFT: Financial Planning to explore the intersection of financial
              planning, AI, and technical finance, the space he wants to build a career
              around.
            </p>
